...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "Area",
        loadChildren: () =>
          import("./Catalogos/Area/area.module").then((a) => a.AreaModule),
      },
      {
        path: "Categoria",
        loadChildren: () =>
          import("./Catalogos/Categoria/categoria.module").then(
            (a) => a.CategoriaModule
          ),
      },
      {
        path: "Sector",
        loadChildren: () =>
          import("./Catalogos/Sector/sector.module").then(
            (a) => a.SectorModule
          ),
      },
      {
        path: "UnidadMedida",
        loadChildren: () =>
          import("./Catalogos/UnidadMedida/medida.module").then(
            (a) => a.MedidaModule
          ),
      },
      {
        path: "Producto",
        loadChildren: () =>
          import("./Catalogos/Producto/producto.module").then(
            (a) => a.ProductoModule
          ),
      },
      {
        path: "Persona",
        loadChildren: () =>
          import("./Catalogos/Persona/persona.module").then(
            (a) => a.PersonaModule
          ),
      },
      {
      ...
      },
      {
        path: "Rol",
        loadChildren: () =>
          import("./Catalogos/Rol/rol.module").then((a) => a.RolModule),
      },
      {
        path: "Usuario",
        loadChildren: () =>
          import("./Usuario/usuario.module").then((a) => a.UsuarioModule),
      },
      {
        path: "Eventos",
        loadChildren: () =>
