...
export class ListadoComponent implements OnInit, OnDestroy {
  ...
  data: any;
  constructor(private areaService: AreaService, private dialogService: NbDialogService, private toastrService: NbToastrService) { }

  //para datatables
  construir(): void {
    this.subscripciones.push(this.areaService.listar().subscribe((resp: any) => {
      this.data = resp;
      this.dtTrigger.next();
    }, error => {
      console.error(error);
  ...
  eliminar(id): void {
    ...
    this.subscripciones.push(this.areaService.eliminar(id.idArea).subscribe(res => {
      if (res) {
