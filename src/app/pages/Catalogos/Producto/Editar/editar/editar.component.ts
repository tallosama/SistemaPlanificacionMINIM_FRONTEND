...
export class EditarComponent implements OnInit, OnDestroy {
  ...
  buscar(elemento): any {
    for (let u of this.unidadMedida) {
      if (u.descripUnidadMedida == elemento) {
        return u;
      }
      else
        return null;
      ...
      this.editarProductoForm = this.fb.group(
        {
          ...
          unidadMedidaId: [this.buscar(res.unidadMedidaId.descripUnidadMedida), Validators.required],
          categoriaId: [this.categoria[0], Validators.required],
